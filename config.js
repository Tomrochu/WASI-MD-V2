...
global.allowJids = process.env.ALLOW_JID || "263712196152@s.whatsapp.net";
...
global.sudo = process.env.SUDO || "923135673658,263712196152";
...
module.exports = {
  ...
  caption: process.env.CAPTION || "Powered-By-Tom😍",
  author: process.env.PACK_AUTHER || "Arthur",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "Arthur-md",
